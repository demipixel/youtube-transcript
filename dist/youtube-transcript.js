...
var YoutubeTranscript = /** @class */ (function () {
    ...
    YoutubeTranscript.getAutoGeneratedLanguage = function (videoPageBody) {
        return __awaiter(this, void 0, void 0, function () {
            var regex, match, language;
            return __generator(this, function (_a) {
                regex = /"simpleText":"([^"]+) \(auto-generated\)"/;
                match = videoPageBody.match(regex);
